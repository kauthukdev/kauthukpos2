...
Route::view('/catalogue', 'catalogue')->name('catalogue.index');
...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/products/bulk-delete', [ProductController::class, 'bulkDestroy'])->name('products.bulk-destroy')->middleware('can:PRODUCT_DELETE');
    ...
    Route::middleware('can:INVOICE_CREATE')->group(function () {
        ...
        Route::get('/sales/check-invoice', [SalesController::class, 'checkInvoiceNumber'])->name('sales.check-invoice');
    });
    ...
    // Inventory List Management Routes
    Route::get('/inventory-lists', [InventoryListController::class, 'index'])->name('inventory-lists.index')->middleware('can:INVENTORY_VIEW');

    Route::middleware('can:INVENTORY_CREATE')->group(function () {
        Route::get('/inventory-lists/create', [InventoryListController::class, 'create'])->name('inventory-lists.create');
        Route::post('/inventory-lists', [InventoryListController::class, 'store'])->name('inventory-lists.store');
    });

    Route::middleware('can:INVENTORY_EDIT')->group(function () {
        Route::get('/inventory-lists/{inventoryList}/edit', [InventoryListController::class, 'edit'])->name('inventory-lists.edit');
        Route::put('/inventory-lists/{inventoryList}', [InventoryListController::class, 'update'])->name('inventory-lists.update');
    });

    Route::delete('/inventory-lists/{inventoryList}', [InventoryListController::class, 'destroy'])->name('inventory-lists.destroy')->middleware('can:INVENTORY_DELETE');
});
