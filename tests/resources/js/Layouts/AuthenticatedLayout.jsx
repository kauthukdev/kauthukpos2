...
export default function AuthenticatedLayout({ header, children }) {
    ...
    return (
        <div className="min-h-screen bg-gray-100">
                    ...
                    <div className="flex h-16 justify-between">
                        <div className="flex items-center">
                            ...
                            <button
                                ...
                                className="flex items-center justify-center rounded-md border border-gray-200 px-2 py-1 text-gray-500 hover:bg-gray-100 hover:text-gray-700 focus:outline-none"
                            >
                                <svg
                                    className="h-5 w-5"
                                    fill="none"
            ...
            <div className="flex">
                <SideBar isOpen={sidebarOpen} setIsOpen={setSidebarOpen} showToggle={false} />
