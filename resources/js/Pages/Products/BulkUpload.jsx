            ...
            header={
                <div className="flex justify-between items-center">
                    ...
                    <div className="flex space-x-4">
                        ...
                        <a
                            href={route('products.download-template')}
                        ...
                        <div className="p-6 bg-white border-b border-gray-200">
                            <div className="mb-8 bg-blue-50 p-4 rounded-lg border border-blue-200">
                                ...
                                <ul className="list-disc pl-5 space-y-2 text-blue-800">
                                    ...
                                    <li>Category should be the <strong>exact Name</strong> of the category (e.g., "Electronics").</li>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <div className="flex items-center justify-end">
                                    <button
                                        ...
                                        className={`px-4 py-2 bg-[#7267ef] text-white rounded-lg hover:bg-[#6357df] focus:bg-[#6357df] transition-colors ${(processing || uploading || !data.file) ? 'opacity-50 cursor-not-allowed' : ''
                                            }`}
                                    >
