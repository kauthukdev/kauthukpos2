...
<head>
    ...
    <link
        href="https://fonts.bunny.net/css?family=exo:400,500,600,700|poppins:300,400,500,600,700|playfair-display:400,600,700|figtree:400,500,600,700&display=swap"
        rel="stylesheet" />
    @viteReactRefresh
...
<body class="antialiased">
    <script>
        ...
        window.catalogueConfig = {
            ...
            logoUrl: `${baseUrl}/images/logo.png`.replace('//images/logo.png', '/images/logo.png'),
        };
    </script>
